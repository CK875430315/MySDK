...
import com.ck.mylibrary.utils.DisplayUtil;
...
public class SlideBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < letters.length; i++) {
            ...
            paint.setTextSize(DisplayUtil.dip2px(getContext(), 12));//使用dipToPixels()方法动态地将dp转换成px以适应不同的屏幕
            // 要画的字母的x,y坐标
...
//                    listenner.onTouchLetterChange(showBg, letters[index]);
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (listenner != null) {
                    ...
                    } else if (index > 0 && index < letters.length-1) {
                        listenner.onTouchLetterChange(showBg, letters[index]);
